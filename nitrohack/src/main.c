...
struct nh_menuitem mainmenu_items[] = {
    {NEWGAME, MI_NORMAL, "新游戏", 'n'},
    {TUTORIAL, MI_NORMAL, "新游戏（教学模式）", 't'},
    {LOAD, MI_NORMAL, "载入游戏", 'l'},
    {REPLAY, MI_NORMAL, "观看录像", 'v'},
    {OPTIONS, MI_NORMAL, "设置", 'o'},
    {TOPTEN, MI_NORMAL, "排行榜", 's'},
#if defined(NETCLIENT)
    {NETWORK, MI_NORMAL, "连接到服务器", 'c'},
#endif
    {EXITGAME, MI_NORMAL, "退出", 'q', 'x'}
};
...
"| |    /  _  \\/  _  \\|  _  \\|  _  ||  __  |/  _  |/  __||   / ",
"| |____| (_) || (_) || | | || (_) || |  | || (_| || (__ | | \\ ",
"|_____/\\_____/\\_____/|_| |_|\\____ ||_|  |_|\\_____|\\____||_|\\_\\",
"                            |_____/               为神而战",
NULL
};
...
static void mainmenu(void)
{
    ...
    const char **nhlogo;
    char verstr[32];
    sprintf(verstr, "版本：v%d.%d.%d", VERSION_MAJOR, VERSION_MINOR, PATCHLEVEL);
